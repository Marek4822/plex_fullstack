...
def update_app(playlist_id, dir_name):
    ...
    def download(playlists_path):
        os.system(f'cd {playlists_path} && /usr/bin/yt-dlp --skip-unavailable-fragments --ignore-errors --continue -R 10 -f 140 -i -a diff_urls.txt')
        

    def main():
        default_destination = '/home/marek/python/plex_fullstack/test_view/' # Default destination
